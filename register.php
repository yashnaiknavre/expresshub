            ...
            if ($password === $confirm_password) {
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Username   = 'paste your email id';                     //SMTP username
                        $mail->Password   = 'paste your gmail encrypted password';                               //SMTP password
                ...
                //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
                        ...
                        //Recipients
                        $mail->setFrom('paste your email id');
...
<head>
    ...
    <!--/Style-CSS -->
    <link rel="stylesheet" href="ucss\login_style.css" type="text/css" media="all" />
    <!--//Style-CSS -->
