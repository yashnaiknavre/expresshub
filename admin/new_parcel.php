...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
        ...
        <table class="table table-bordered" id="parcel-items">
          ...
          <tbody>
            <tr>
              <td><input type="text" id="weight" name='weight[]' value="<?php echo isset($weight) ? $weight :'' ?>" required></td>
              <td><input type="text" id="height" name='height[]' value="<?php echo isset($height) ? $height :'' ?>" required></td>
              <td><input type="text" id="length" name='length[]' value="<?php echo isset($length) ? $length :'' ?>" required></td>
              <td><input type="text" id="width" name='width[]' value="<?php echo isset($width) ? $width :'' ?>" required></td>
              <td><input type="text" id="price" class="text-right number" name='price[]' value="<?php echo isset($price) ? $price :'' ?>" required ></td>
              <?php if(!isset($id)): ?>
          ...
          <tfoot>
            ...
            <th ><label class="text-right" id="tAmount">00.0</label></th>
            <th></th>
          </tfoot>
              <?php endif; ?>
        </table>
