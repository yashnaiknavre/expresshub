...
?>
<head>
  <script src="user/calculate.js"></script>
  ...
  <div class="content-wrapper">
	...
	<div class="card card-outline card-primary">
        ...
        <table class="table table-bordered" id="parcel-items">
          ...
          <tbody>
            <tr>
              <td><input type="text" name='weight[]' id="weight" value="<?php echo isset($weight) ? $weight :'' ?>" required></td>
              <td><input type="text" name='height[]' id="height" value="<?php echo isset($height) ? $height :'' ?>" required></td>
              <td><input type="text" name='length[]'id="length" value="<?php echo isset($length) ? $length :'' ?>" required></td>
              <td><input type="text" name='width[]' id="width" value="<?php echo isset($width) ? $width :'' ?>" required></td>
              <td><input type="text" class="text-right number" id="price" name='price[]' value="<?php echo isset($price) ? $price :'' ?>" required disable></td>
              <?php if(!isset($id)): ?>
          ...
          <tfoot>
            ...
            <th class="text-right" id="tAmount"><php? echo  $calculate ?></th>
            <th></th>
          </tfoot>
              <?php endif; ?>
        </table>
  	...
  	<div class="card-footer border-top border-info">
        ...
        <button class="btn btn-flat  bg-gradient-primary mx-2" onclick="calculateVolume()">Calculate price</button>
        <div class="floating-label mt-3">
                                        ...
                                        <label class="select_label">Select Payment Method</label>
                                          <option></option>
                                          <option>Pay while Pickup</option>
                                        </select>
                                        <span class="highlight"></span>
                                    </div>
  			<a name="save" href="confirmation.php" class="btn btn-flat  bg-gradient-primary mx-2" form="manage-parcel">Save</a>
...
<div id="ptr_clone" class="d-none">
  <table>
    <tr>
        ...
        <td><input type="text"  id="price" class="text-right number" name='price[]' required ></td>
        <button class="btn btn-flat  bg-gradient-primary mx-2" onclick="calculateVolume()"></button>
...
<php? 
$calculate = $weight*$height*$length*width;
?>
<script>
